...
class StudentSerializer(serializers.ModelSerializer):
    ...
    # Flat write endpoints for contacts
    ...
    class Meta:
        model = Student
        fields = ('id', 'username', 'email', 'first_name', 'last_name', 'user_group', 'group_name', 'date_of_birth', 'is_currently_study', 'contacts', 'phone', 'tg_name', 'is_student')
        
    def create(self, validated_data):
        phone = validated_data.pop('phone', None)
        tg_name = validated_data.pop('tg_name', None)
        
        # User requested autogenerated password logic instead of manual field
